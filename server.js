 ...
 * @typedef {{id: string, questions: Array, questionCount?: number}} FetchedQuizData
 * @typedef {{percentScore: number, score: number, questionsWithAnswers: Array}} QuizResultsProps
 */
